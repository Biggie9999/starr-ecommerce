...
<p>Bodine Electrics has a proposal for a partnership on a procurement project that I want you to attend to as soon as possible.</p>
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        send_campaign(sys.argv[1], "bodine_email_template.html")
