...
new_entries = [
    {"company": "Motoren Kalis GmbH (mo-ka)", "name": "Markus Kalis", "email": "markus.kalis@mo-ka.de"},
    {"company": "Lavastica International B.V.", "name": "Daan Korenhoff", "email": "daan.korenhoff@lavastica.com"}
]
