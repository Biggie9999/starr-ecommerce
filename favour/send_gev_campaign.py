...
<p>General Europe Vacuum has a proposal for a partnership on a procurement project that I want you to attend to as soon as possible.</p>
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 send_gev_campaign.py leads.csv")
    else:
        send_campaign(sys.argv[1], "gev_email_template.html")
