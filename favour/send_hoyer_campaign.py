...
<p>Hoyer Motors has a proposal for a partnership on a procurement project that I want you to attend to as soon as possible.</p>
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 send_hoyer_campaign.py leads.csv")
    else:
        send_campaign(sys.argv[1], "hoyer_email_template.html")
