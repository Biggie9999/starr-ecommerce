...
<p>Edwards Fire Safety has a proposal for a partnership on a procurement project that I want you to attend to as soon as possible.</p>
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 send_edwards_campaign.py leads.csv")
    else:
        send_campaign(sys.argv[1], "edwards_email_template.html")
